...
function loadData() {  
  ...
  skills = {
    technomancer: [
      ...
      /* 58 */ [ 0, [ 53, 56, 57, 60, 61 ], [ 53, 56, 57, 59, 60, 61 ], "アノマリーの充填", { "アノマリーパワー": 0.06 } ],
    ...
    trickster: [
      ...
      /* 27 */ [ 0, [ 26 ], [], "生命の連鎖", { "[HM]短射程距離で死亡した敵1体につき、体力が回復": 0.1 } ],
      ...
      /* 44 */ [ 0, [ 43 ], [], "四面楚歌", { "短射程距離の敵1体につき、アーマーが15%上昇する。": null } ],
      ...
      /* 51 */ [ 0, [ 50 ], [], "生命の連鎖", { "[HM]短射程距離で死亡した敵1体につき、体力が回復": 0.1 } ],
      ...
      /* 61 */ [ 0, [ 58, 62 ], [ 58, 62 ], "連撃", { "スキルクールダウン (攻撃属性)": 0.15 } ],
      ...
      /* 71 */ [ 0, [ 70 ], [ 72 ], "連撃", { "スキルクールダウン (攻撃属性)": 0.15 } ],
    ...
    devastator: [
       ...
       /* 46 */ [ 0, [ 45 ], [ 47, 48 ], "戦場の覇者", { "[HM]短射程距離で死亡した敵1体につき、体力が回復": null } ],
